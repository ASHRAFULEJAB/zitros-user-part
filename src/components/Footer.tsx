    ...
    <div>
      <footer className="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="">
              ...
              md:justify-start"
              >
                <span className="me-0 [&>svg]:h-4 [&>svg]:w-4"></span>
                About Us
              </h6>
              <p className="mb-2">
                <a href="#!">About Amjanata</a>
              </p>
              <p className="mb-2">
                <a href="#!">Careers</a>
              </p>
        ...
        <div className="flex mx-auto items-center justify-center">
          ...
          <p className="bg-black text-black h-full p-7 mt-3">k</p>
      </footer>
    </div>
  );
};
